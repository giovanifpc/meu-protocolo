...
- **Não testado ainda em produção** — só validação de sintaxe JS e revisão de código nesta sessão (login por OTP impede teste end-to-end fora do notebook/com conta real). Precisa de teste real do usuário: criar cardio manual, gerar via IA, executar como aluno (marcar feito + registrar tempo), conferir overview e histórico.
